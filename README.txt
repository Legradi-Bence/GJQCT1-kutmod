...
This is the readme for RobotiCoffee, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. RobotiCoffee) > Ok.
...
- To run the project find RobotiCoffee.java (which will be in under src/main/java/roboticoffee) and right click > Run 'RobotiCoffee'
